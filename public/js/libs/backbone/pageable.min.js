...
! function(a) {
    ...
    var f = a.extend,
        ...
        v = Math.floor,
        w = Math.max,
        x = b.Collection.prototype,
        y = /[\s'"]/g,
        z = /[<>\s'"]/g,
        A = b.PageableCollection = b.Collection.extend({
            state: {
                firstPage: 1,
                lastPage: null,
                currentPage: null,
            ...
            constructor: function(a, b) {
                x.constructor.apply(this, arguments), b = b || {};
                var c = this.mode = b.mode || this.mode || B.mode,
                    d = f({}, B.queryParams, this.queryParams, b.queryParams || {});
                d.directions = f({}, B.queryParams.directions, this.queryParams.directions, d.directions || {}), this.queryParams = d;
                var e = this.state = f({}, B.state, this.state, b.state || {});
                e.currentPage = null == e.currentPage ? e.firstPage : e.currentPage, o(a) || (a = a ? [a] : []), "server" == c || null != e.totalRecords || l(a) || (e.totalRecords = a.length), this.switchMode(c, f({
                    fetch: !1,
                    resetState: !1,
                    models: a
                }, b));
                ...
                if (e.sortKey && !g && this.setSorting(e.sortKey, e.order, b), "server" != c) {
                    ...
                    g && b.full && (this.comparator = null, i.comparator = g), b.full && i.sort(), a && !l(a) && (this.reset([].slice.call(a), f({
                        silent: !0
                    }, b)), this.getPage(e.currentPage), a.splice.apply(a, [0, a.length].concat(this.models)))
                }
                this._initState = h(this.state)
            },
            _makeFullCollection: function(a, c) {
                var d, e, f, g = ["url", "model", "sync", "comparator"],
                    h = this.constructor.prototype,
                    i = {};
                for (d = 0, e = g.length; e > d; d++) f = g[d], s(h[f]) || (i[f] = h[f]);
                var j = new(b.Collection.extend(i))(a, c);
                for (d = 0, e = g.length; e > d; d++) f = g[d], this[f] !== h[f] && (j[f] = this[f]);
                return j
            },
            _makeCollectionEventHandler: function(a, b) {
                return function(c, d, g, j) {
                    ...
                    if ("add" == c) {
                        var t, v, w, x, j = j || {};
                        if (g == b) v = b.indexOf(d), v >= p && q > v && (x = a, t = w = v - p);
                        else {
                            t = a.indexOf(d), v = p + t, x = b;
                            var w = s(j.at) ? v : j.at + p
                        } if (j.onRemove || (++l.totalRecords, delete j.onRemove), a.state = a._checkState(l), x) {
                            x.add(d, f({}, j || {}, {
                                at: w
                            }));
                            var y = t >= o ? d : !s(j.at) && q > w && a.length > o ? a.at(o) : null;
                            y && e(g, c, function() {
                                a.remove(y, {
                                    onAdd: !0
                                })
                    ...
                    if ("remove" == c)
                        if (j.onAdd) delete j.onAdd;
                        else {
                            if (--l.totalRecords) {
                                var z = l.totalPages = u(l.totalRecords / o);
                    ...
                    if ("reset" == c)
                        if (j = g, g = d, g == a && null == j.from && null == j.to) {
            ...
            _checkState: function(a) {
                ...
                if (null != e && null != f && null != g && null != h && ("infinite" == b ? d : !0)) {
                    ...
                    if (i = a.totalPages = u(e / f), 0 > h || h > 1) throw new RangeError("`firstPage must be 0 or 1`");
                    if (a.lastPage = 0 === h ? w(0, i - 1) : i || h, "infinite" == b) {
            ...
            setPageSize: function(a, b) {
                a = c(a, "pageSize"), b = b || {
                    first: !1
                };
                var d = this.state,
                    e = u(d.totalRecords / a),
                    h = e ? w(d.firstPage, v(e * (d.firstPage ? d.currentPage : d.currentPage + 1) / d.totalPages)) : d.firstPage;
            ...
            switchMode: function(b, c) {
                ...
                if ("server" == b || l) "server" == b && l && (i(r(m), function(a) {
                ...
                }), delete this._handlers, this._fullComparator = l.comparator, delete this.fullCollection);
                else {
                    ...
                    for (var o = this.links = {}, p = d.firstPage, q = u(d.totalRecords / d.pageSize), s = 0 === p ? w(0, q - 1) : q || p, t = d.firstPage; s >= t; t++) o[t] = this.url;
            ...
            getPageByOffset: function(a, b) {
                if (0 > a) throw new RangeError("`offset must be > 0`");
                a = c(a);
                var d = v(a / this.state.pageSize);
            ...
            sync: function(a, c, d) {
                ...
                return (x.sync || b.sync).call(e, a, c, d)
            },
            ...
            fetch: function(a) {
                ...
                var e = a.data || {},
                    i = t(a, "url") || t(this, "url") || "",
                    k = i.indexOf("?"); - 1 != k && (f(e, d(i.slice(k + 1))), i = i.slice(0, k)), a.url = i, a.data = e;
                var l, n, o, q, u = "client" == this.mode ? j(this.queryParams, "sortKey", "order") : g(j(this.queryParams, r(B.queryParams)), "directions"),
                    v = m(u),
                    w = h(this);
                for (l = 0; l < v.length; l++) n = v[l], o = n[0], q = n[1], q = p(q) ? q.call(w) : q, null != b[o] && null != q && (e[q] = b[o]);
                b.sortKey && b.order ? e[u.order] = this.queryParams.directions[b.order + ""] : b.sortKey || delete e[u.order];
                var y = m(g(this.queryParams, r(B.queryParams)));
                for (l = 0; l < y.length; l++) n = y[l], q = n[1], q = p(q) ? q.call(w) : q, null != q && (e[n[0]] = q);
                if ("server" != c) {
                    var z = this,
                    ...
                    return a.success = function(b, d, e) {
                        ...
                        var g = b.models;
                        "client" == c ? A.reset(g, e) : (A.add(g, f({
                            at: A.length
                        }, f(e, {
                            parse: !1
                        }))), z.trigger("reset", z, e)), C && C(b, d, e)
                    }, x.fetch.call(this, f({}, a, {
                        silent: !0
                    }))
                }
                return x.fetch.call(this, a)
            },
            _makeComparator: function(a, b, c) {
                var d = this.state;
                return a = a || d.sortKey, b = b || d.order, a && b ? (c || (c = function(a, b) {
                    return a.get(b)
                }), function(d, e) {
                    var f, g = c(d, a),
                        h = c(e, a);
